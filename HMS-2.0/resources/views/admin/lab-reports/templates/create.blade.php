 ...
 @section('page-title', 'Create Report Template')
 @section('page-description', 'Create a new lab report template')
     ...
     <div class="max-w-7xl mx-auto">
         ...
         <div class="mb-6 sm:mb-8">
             <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                 <div>
                     <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Create Report Template</h1>
                     <p class="mt-1 text-sm sm:text-base text-gray-600">Design a template for lab reports</p>
                 </div>
         ...
         <form id="templateForm" method="POST" action="{{ route('admin.lab-reports.templates.store') }}" class="space-y-6">
             @csrf
     ...
     <div class="section-item bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-4 sm:p-6 space-y-4">
         ...
         <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
             <div>
                 ...
                 <input type="text"
                     -500 focus:border-blue-500 transition-colors duration-200 section-name"
