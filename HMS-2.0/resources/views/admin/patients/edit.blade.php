        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Update patient record - {{ $patient->full_name }}</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="age" id="ageInput"
                            ...
                            value="{{ old('age', $patient->date_of_birth ? \Carbon\Carbon::parse($patient->date_of_birth)->age : '') }}"
                            min="0" max="150" placeholder="Enter age in years" required>
                        <!-- Hidden field for actual date_of_birth submission -->
                        <input type="hidden" name="date_of_birth" id="dateOfBirthHidden" value="{{ old('date_of_birth', $patient->date_of_birth) }}">
                    ...
                    <div>
                        ...
                        <select name="blood_group"
                            ...
                            <option value="{{ $bloodGroup }}" {{ old('blood_group', $patient->blood_group) == $bloodGroup ? 'selected' : '' }}>
                                {{ $bloodGroup }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="emergency_contact_relationship"
                            ...
                            <option value="{{ $relationship }}" {{ old('emergency_contact_relationship', $patient->emergency_contact_relationship) == $relationship ? 'selected' : '' }}>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="medical_history" rows="3"
                            ...
                            placeholder="Previous surgeries, chronic conditions, etc.">{{ old('medical_history', $patient->medical_history) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="allergies" rows="2"
                            ...
                            placeholder="Drug allergies, food allergies, etc.">{{ old('allergies', $patient->allergies) }}</textarea>
                        @error('allergies')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3"
                            ...
                            placeholder="Any additional information about the patient">{{ old('notes', $patient->notes) }}</textarea>
                        @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        <div id="currentImage">
                            <img src="{{ asset('storage/' . $patient->profile_image) }}" alt="Current Profile" class="w-24 h-24 rounded-full object-cover border-4 border-gray-200">
                        </div>
                        @endif
                        <div id="imagePreview" class="hidden">
                            <img id="previewImg" src="" alt="Preview" class="w-24 h-24 rounded-full object-cover border-4 border-gray-200">
                        </div>
                        <div id="defaultAvatar" class="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center {{ $patient->profile_image ? 'hidden' : '' }}">
                    ...
                    <div class="flex-1">
                        ...
                        <label for="profileImage"
                            ...
                            {{ $patient->profile_image ? 'Change Image' : 'Choose Image' }}
                        </label>
...
<div id="loadingOverlay" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg p-6 flex items-center space-x-4">
        ...
        <span class="text-sm font-medium text-gray-900">Updating patient...</span>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (window.innerWidth <= 768) {
            ...
            const ageInputMobile = document.querySelector('input[name="age"]');
            if (ageInputMobile) {
                ageInputMobile.setAttribute('inputmode', 'numeric');
            }
        }
        ...
        console.log('Patient edit form initialized');
    });
</script>
@endpush