...
<body>
    ...
    $maxRows = 35; // Adjust based on page size
    $displayData = array_slice($breakdown, 0, $maxRows);
    @endphp
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="footer">
                ...
                @if(count($breakdown) > $maxRows)
                | Showing first {{ $maxRows }} of {{ count($breakdown) }} days
                @endif
            </div>
        </div>
    </div>
