...
@section('page-title', 'Edit Letterhead')
@section('page-description', 'Update letterhead information')
    ...
    <div class="bg-white shadow-sm rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-medium text-gray-900">Edit Letterhead</h3>
        ...
        <form action="{{ route('super-admin.letterheads.update', $letterhead) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <select id="business_id"
                    ...
                    <option value="{{ $business->id }}" {{ old('business_id', $letterhead->business_id) == $business->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="text"
                    ...
                    value="{{ old('business_name_bangla', $letterhead->business_name_bangla) }}"
            ...
            <div>
                ...
                <input type="text"
                    ...
                    value="{{ old('business_name_english', $letterhead->business_name_english) }}"
            ...
            <div>
                ...
                <textarea id="location"
                    ...
                    required>{{ old('location', $letterhead->location) }}</textarea>
                @error('location')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <select id="type"
                    ...
                    <option value="Invoice" {{ old('type', $letterhead->type) == 'Invoice' ? 'selected' : '' }}>Invoice</option>
                    <option value="Lab Report" {{ old('type', $letterhead->type) == 'Lab Report' ? 'selected' : '' }}>Lab Report</option>
                </select>
                @error('type')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div id="contacts-container">
                    @php
                    $contacts = old('contacts', $letterhead->getContactsArray());
                    @endphp
                    @if($contacts)
            ...
            <div>
                ...
                <div id="emails-container">
                    @php
                    $emails = old('emails', $letterhead->getEmailsArray());
                    @endphp
                    @if($emails)
            ...
            <div>
                <div class="flex items-center">
                    <input id="status_active"
                        ...
                        type="radio"
                        value="Active"
                        {{ old('status', $letterhead->status) == 'Active' ? 'checked' : '' }}
                ...
                <div class="flex items-center mt-2">
                    <input id="status_inactive"
                        ...
                        type="radio"
                        value="Inactive"
                        {{ old('status', $letterhead->status) == 'Inactive' ? 'checked' : '' }}
                        class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300">
