...
@section('page-title', 'Edit Global Setting')
@section('page-description', 'Modify an existing global setting')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900">Edit Global Setting</h2>
            <p class="mt-1 text-sm text-gray-600">Modify the setting "{{ $setting->key }}".</p>
        </div>

        <form action="{{ route('super-admin.settings.update', $setting) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <select name="type" id="type"
                    ...
                    <option value="decimal" {{ old('type', $setting->type) === 'decimal' ? 'selected' : '' }}>Decimal</option>
