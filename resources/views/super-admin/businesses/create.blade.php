...
@section('page-description', 'Create a new hospital in the system')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-sm rounded-lg">
        ...
        <form action="{{ route('super-admin.businesses.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Uncheck to create the hospital as inactive</p>
            </div>
