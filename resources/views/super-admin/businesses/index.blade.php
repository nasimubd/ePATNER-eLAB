...
@section('page-description', 'Manage all hospitals in the system')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Hospitals</h2>
            <p class="text-gray-600">Manage all hospitals in the system</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $businesses->total() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $businesses->where('is_active', true)->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Inactive Hospitals</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $businesses->where('is_active', false)->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">All Hospitals</h3>
        </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">{{ $business->hospital_name }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $business->contact_number }}</div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900 max-w-xs truncate">{{ $business->address }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
        ...
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">Get started by creating a new hospital.</p>
            <div class="mt-6">
                <a href="{{ route('super-admin.businesses.create') }}"
