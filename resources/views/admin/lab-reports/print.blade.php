        ...
        <div class="letterhead-space">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; height: 100%; padding: 0 10px;">
                ...
                <div style="flex: 0 0 70px; display: flex; align-items: center; justify-content: center;">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo" style="max-width: 100%; max-height: 70px; object-fit: contain;">
                </div>
                ...
                <div style="flex: 1; text-align: center; padding-left: 15px;">
                    ...
                    <div style="font-size: 14px; font-weight: bold; color: #000; margin-bottom: 2px; font-family: 'Arial', sans-serif;">
